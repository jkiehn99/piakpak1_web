...
class App(tk.Tk):
    ...
    def _build_right_panel(self, parent):
        ...
        columns = ('email', 'password', 'token', 'user_id', 'reg_time', 'invite', 'pro')
        ...
        self._acct_tree.heading('pro', text='Pro', anchor='center')
        ...
        self._acct_tree.column('pro', width=60, minwidth=50, anchor='center')
    ...
    def _export_accounts(self):
        ...
        with open(path, 'w', encoding='utf-8-sig') as f:
            f.write('邮箱,密码,Token,用户ID,注册时间,邀请,Pro\n')
            for item in self._acct_tree.get_children():
